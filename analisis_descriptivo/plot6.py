...
ax = sns.lineplot(x='variedad',y='value',data=dd,hue='Enfermedad',palette=paleta)
sns.despine()
plt.xlabel('variedad')
plt.xticks(rotation = 90)
plt.ylabel('INCIDENCIA')
plt.savefig("analisis_descriptivo\\plot6.png",bbox_inches='tight')
