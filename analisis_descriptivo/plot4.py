...
dd=pd.melt(iea,id_vars=['año'],value_vars=[*nombres.values()],var_name='Enfermedad')
...
ax = sns.lineplot(x='año',y='value',data=dd,hue='Enfermedad',palette=paleta)
sns.despine()
plt.xlabel('AÑO')
plt.ylabel('INCIDENCIA')
plt.savefig("C:\\Users\\Biomodelacion\\Desktop\\ProyectoArroz\\analisis_descriptivo\\plot4.png")
